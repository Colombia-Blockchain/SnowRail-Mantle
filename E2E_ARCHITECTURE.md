...
└──────────────────────────────────────┘
       │
       │ 9. User Verifies on MantleScan
       ↓
┌──────────────────────────────────────┐
│  MANTLESCAN (Block Explorer)         │
│  ├── View Transaction                │
│  ├── Confirm Execution               │
...
| Wallet won't connect | Chain mismatch | Switch to Mantle Sepolia (5003) in MetaMask |
...
- [ ] MetaMask shows Mantle Sepolia (Chain ID 5003)
...
- [ ] Transaction visible on MantleScan
